...
$_CONFIG['upload_dir']                            = VSHARE_DIR . '/video/';                                                                  // Path to upload directory
...
$_CONFIG['redirect_url']                          = VSHARE_URL . '/upload_file.php';                                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(flv|3gp|mp4|mov|asf|mpg|avi|mpeg|wmv|rm|dat|m4v)';                                                  // Include file extentions that are allowed to be uploaded
...
$_CONFIG['path_to_upload']                        = VSHARE_URL . '/video/';                                                           // Used for a web link to the uploaded file
