<div id="page" class="upload-success">
    ...
    {if $video_processed ne 1}
        <span class=highlight>Your video was successfully added!</span>
    {/if}

    {if $video_processed eq 1}
    
        <p><a href="{$base_url}/view/{$video_info.video_id}/{$video_info.video_seo_name}/">{$base_url}/view/{$video_info.video_id}/{$video_info.video_seo_name}/</a></p>
        ...
        <h2>Share your video (Optional):</h2>
        ...
        <form method="post" action="" name="linkForm">
            ...
            {if $embed_show eq "1" && $video_info.video_vtype == 0}
                ...
                <p>Put this video on your Web site!, 
                Copy and paste the code below to embed the video.</p>
                ...
                onclick="javascript:document.linkForm.video_play.focus();document.linkForm.video_play.select();" readonly="readonly" />
            {/if}
