<div class="col-md-3">
    {include file="menu_settings.tpl" active="profile"}
</div>
<div class="col-md-9" id="user-profile-edit">
    ...
    <form method="post" action="" enctype="multipart/form-data" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">Personal Website:</label>
            <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">Occupations:</label>
            <div class="col-md-6">
