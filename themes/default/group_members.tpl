                    ...
                    <div class="thumbnail">
    					...
    					<div class="caption">
    						...
    						<h5>
                                ...
                                <small>member since: {$group_members[i].group_member_since|date_format}</small>
    						</h5>
    						...
    						<p>
    							{if $smarty.session.UID eq $group_info.group_owner_id and $group_members[i].group_member_approved eq "no"}
    								...
    								<button type="submit" class="btn btn-default" name="approve_mem">Approve {$uname}</button>
    								</form>
    							{/if}
    							...
    							{if $smarty.session.UID eq $group_info.group_owner_id and $group_info.group_owner_id ne $group_members[i].group_member_user_id}
    								...
    								<button type="submit" class="btn btn-default" name="remove_mem">Remove From Group</button>
    								</form>
    							{/if}
    						</p>
    					</div>
