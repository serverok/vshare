...
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(6, 'player_top', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="728px" height="90px"></a></p>', 'Inactive');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(7, 'player_bottom', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="728px" height="90px"></a></p>', 'Inactive');
