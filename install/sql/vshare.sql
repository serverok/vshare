...
INSERT INTO `email_templates` (`email_id`, `email_subject`, `email_body`, `comment`) VALUES('user_signup_verify_admin_active', 'Account activated on [SITE_NAME]', '<p>Hi [USERNAME],</p><p>Your account on "[SITE_NAME]" has been activated by administrator, you may login now.</p><p>Your password has been securely stored in our database and cannot be retrieved. In the event that it is forgotten, you will be able to reset it using the email address associated with your account.</p>', 'Send mails to users after verified by Admin');
...
INSERT INTO `sconfig` (`soption`, `svalue`) VALUES('version', '3.1');
