...
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(3, 'home_right_box', '<p><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-vertical.png" height="250px" width="250px"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(4, 'video_right_single', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-vertical.png" height="280px" width="336px"></a></p>', 'Active');
