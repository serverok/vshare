...
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(1, 'banner_top', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="728px" height="90px" style="max-width: 100%;"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(2, 'banner_bottom', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="728px" height="90px" style="max-width: 100%;"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(3, 'home_right_box', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-vertical.png" width="250px" height="250px" style="max-width: 100%;"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(4, 'video_right_single', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-vertical.png" width="300px" height="250px" style="max-width: 100%;"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(5, 'wide_skyscraper', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-vertical.png" width="160px" height="600px" style="max-width: 100%;"></a></p>', 'Active');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(6, 'player_top', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="468px" height="60px" style="max-width: 100%;"></a></p>', 'Inactive');
INSERT INTO `adv` (`adv_id`, `adv_name`, `adv_text`, `adv_status`) VALUES(7, 'player_bottom', '<p class=text-center><a href="http://buyscripts.in/docs/vshare/3.0/advertisements" target="_blank"><img src="/themes/default/images/placeholder-horizontal.png" width="468px" height="60px" style="max-width: 100%;"></a></p>', 'Inactive');
